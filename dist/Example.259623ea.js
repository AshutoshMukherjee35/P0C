...
})({"aWF1H":[function(require,module,exports,__globalThis) {
...
module.bundle.HMR_BUNDLE_ID = "87efc7d7259623ea";
"use strict";
...
},{}],"k3Tmd":[function(require,module,exports,__globalThis) {
...
const Example = ()=>{
    ...
    const { isAuthenticated } = (0, _auth0React.useAuth0)();
    if (isLoading || isAuthenticated === undefined) return /*#__PURE__*/ (0, _jsxDevRuntime.jsxDEV)((0, _loadingScreenDefault.default), {}, void 0, false, {
...
_s(Example, "XkFVloJXMi+jAfALLQLqNKoJGuc=", false, function() {
    return [
...
},{"react/jsx-dev-runtime":"dVPUn","react":"jMk1U","../utils/useAuthActions":"je5I7","./LoadingScreen":"1Dgem","@auth0/auth0-react":"6XUEC","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT","@parcel/transformer-react-refresh-wrap/lib/helpers/helpers.js":"7h6Pi"}],"je5I7":[function(require,module,exports,__globalThis) {
...
const useAuthActions = ()=>{
    _s();
    const { loginWithRedirect, isAuthenticated, isLoading, user } = (0, _auth0React.useAuth0)();
...
_s(useAuthActions, "F/VyMxrXasWFXCFbey7m3nJBnQw=", false, function() {
    return [
        (0, _auth0React.useAuth0),
...
},{"react":"jMk1U","@auth0/auth0-react":"6XUEC","react-router":"2jawN","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT","@parcel/transformer-react-refresh-wrap/lib/helpers/helpers.js":"7h6Pi"}]},["aWF1H"], null, "parcelRequire5a60")

//# sourceMappingURL=Example.259623ea.js.map
